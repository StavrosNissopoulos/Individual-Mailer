...
public class UserB extends User {
	...
	public UserB(int id, String usename, String passw, int type, Database myDb) {
	...
	public void readMessages() {
		...
		if (titles.size() != 0) {
			...
			System.out.println("\nPlease enter the number of the message you want to read and edit or 0 to go back");
			...
			if (messageSelected != 0) {
				...
				do {
					...
					System.out.println("Press 2 to reply to this message");
